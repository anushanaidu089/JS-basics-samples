(function(){
    ...
    var beta = ['ANUSHA', 55, false, null]; // beta has four indexes which means the length of beta is 4
    ...
    //console.log(alpha[0].firstName); // Anusha
    ...
    */
    ...
    console.log(arrayToBeJoined.join()); // 'Srikar ,Anusha , Viswa , Kandi'
